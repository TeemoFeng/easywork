...
for(var i=0;i<_84.pageList.length;i++){
	if(_84.pageList[i]>=100000000000){
		$("<option></option>").val(_84.pageList[i]).text('ALL').appendTo(ps);
	}else{
		$("<option></option>").val(_84.pageList[i]).text(_84.pageList[i]).appendTo(ps);
	} 
}
...
tit = "title=\""+opts.tools[i].title+"\"";
}else{
tit = '';
}
var t=$("<a "+tit+" href=\"javascript:void(0)\"></a>").addClass(opts.tools[i].iconCls).appendTo(tool);
...
var t=$("<a "+tit+" href=\"javascript:void(0)\"></a>").appendTo(_31f);
...
minlen:{validator: function(value, param){return $.trim(value.length) >= param[0];}
,message: 'Please enter at least {0} characters.'},
maxlen:{validator: function(value, param){return $.trim(value.length) <= param[0];}
,message: 'Please enter at less {0} characters.'},
idcard:{validator: function(value, param){
var val=$.trim(value);var ma = val.match(/[^a-z\d]/i);if(!ma){return val.length == param[0]||val.length == param[1]}
},message: 'Please enter at {0} characters or {1} characters.'},
ptext:{validator: function(value){
var val=$.trim(value);var ma = val.match(/[\<\>]/i);if(!ma){return value;}	}
,message: 'Please enter valid data.'},
remote:{validator:function(_446,_447){
var data={};
data[_447[1]]=_446;
