...
</script><div id="LinkageCon" class="con" onselectstart="return false;" style="-moz-user-select:none;"><table id="Linkage"></table></div><div id="selectInputLinkage" style="display:none"><span class="datagrid-btn-separator-nofloat"  style="margin-right:2px;"></span><input id="seleCPLinkage" size="18"  /></div><div id="addLinkage"></div>